...
const routes = [
  { path: '/', exact: true, name: 'Strona domowa' },
  { path: '/dashboard', name: 'Panel administracyjny', component: Dashboard },
  { path: '/places', name: 'Miejsca', component: Places, exact: true },
  { path: '/users', name: 'Użytkownicy', component: Users, exact: true },
